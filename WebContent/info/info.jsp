...
<head>
<meta charset="UTF-8">
<title>회원  가입 게시판 커뮤니티 프로젝트 설계 계획</title>
</head>
<body>
...
3. JSP는 화면 구현과, DB 처리(..Pro.jsp)를 담당
- 되도록 최대한 JSP는 html만 있도록 하고, JAVA  코드를 외부로 분리

-------------

< JAVA의 클래스를 최대한 활용 >
DTO - Data Transfer Object : jsp 페이지에서 데이터의 이동을 담당하는 클래스
-- VO(Value Object), DataBean
DAO - Data Access Object : jsp 페이지에서 DB의 연결과 질의를 담당하는
-- DBBean
