...
<body>
	...
	if (request.getParameter("num") != null) { // 글번호가 있다면, 댓글이라면
	...
	<div id="container">
		<div class="m_title">
			<a href="boardList.jsp">카메라 게시판</a>
		</div>
		<%
			if (request.getParameter("num") != null) {
		%>
		<div class="s_title s_title_re">댓글 등록</div>
		<br>
		<%
			} else {
		%>
		...
		<form action="boardWritePro.jsp" method="post" name="writeForm">
			...
			<table>
				<tr>
					<th width="15%">작성자</th>
					<td width="85%"><span class="c_id"><input type="text"
					name="writer" id="writer" value="<%=memberId%>" size="20"
					readonly></span></td>
				</tr>
				<tr>
					<th>제목</th>
				...
				<tr>
					<th>내용</th>
					<td class="c_text"><textarea rows="22" cols="56"
					name="content" id="content"></textarea></td>
				</tr>
			</table>
			<div class="btns">
				<%if (request.getParameter("num") != null) {%>
				<input type="button" value="댓글 등록" id="btn_write"
					class="btn_write_re">
				<%} else {%>
